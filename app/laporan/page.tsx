...
export default async function LaporanPage({
  ...
  // 2. Get month from URL param or default to current month
  ...
  return (
    <div style={{
      ...
      {/* Summary card */}
      <div style={{
        background: totalIncome - totalExpense >= 0 ? '#0d7a5f' : '#d94f3d',
        ...
        <h2 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '16px' }}>
          RM {((Math.abs(totalIncome - totalExpense)) / 100).toFixed(2)}
